...
export default new Command({
  builder: new SlashCommandBuilder().setName("jump").setDescription("Jump to a song in the queue"),
  ...
  run: async (ctx) => {
    ...
    musicService.jump(ctx.guildId as string, pos);

    ctx.ephemeralReply("Jumped!");
  },
